...
Rails.application.configure do
  ...
  # Assets not available in API-only mode
  ...
  # config.action_dispatch.x_sendfile_header = "X-Accel-Redis" # for NGINX
  ...
  # config.active_job.queue_name_prefix = "strongmind_production"
  ...
  config.active_support.fallback_locales = [ :en ]
